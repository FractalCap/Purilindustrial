        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-6">
              <img src="/logopuri.png" alt="Purifil" className="h-10 w-auto brightness-0 invert opacity-80" />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li><a href="#" className="hover:text-primary transition-colors">Tratamiento de Agua</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Purificación de Aire</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Sector Agroindustrial</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Sector Institucional</a></li>
